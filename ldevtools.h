...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_value)(lua_State* L, const TValue* value);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_nil)(lua_State* L, const TValue* nil_object);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_boolean)(lua_State* L, const int bool_val);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_table)(lua_State* L, const Table* table);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_lua_closure)(lua_State* L, const LClosure* lclosure);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_c_closure)(lua_State* L, const CClosure* cclosure);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_c_light_func)(lua_State* L, const lua_CFunction light_func);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_user_data)(lua_State* L, const char* user_data);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_light_user_data)(lua_State* L, const void* light_user_data);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_int_number)(lua_State* L, const lua_Integer int_num);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_float_number)(lua_State* L, const lua_Number float_num);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_str)(lua_State* L, const TString* str);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_short_string)(lua_State* L, const TString* string);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_long_string)(lua_State* L, const TString* string);
