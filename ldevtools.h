...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_value)(const int indent, lua_State* L, const TValue* value);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_nil)(const int indent, lua_State* L, const TValue* nil_object);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_boolean)(const int indent, lua_State* L, const int bool_val);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_table)(const int indent, lua_State* L, const Table* table);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_c_closure)(const int indent, lua_State* L, const CClosure* cclosure);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_c_light_func)(const int indent, lua_State* L, const lua_CFunction light_func);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_thread)(const int indent, lua_State* L, lua_State* lua_thread);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_user_data)(const int indent, lua_State* L, const char* user_data);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_light_user_data)(const int indent, lua_State* L, const void* light_user_data);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_int_number)(const int indent, lua_State* L, const lua_Integer int_num);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_float_number)(const int indent, lua_State* L, const lua_Number float_num);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_str)(const int indent, lua_State* L, const TString* str);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_short_string)(const int indent, lua_State* L, const TString* string);
...
/*
		...
		Return: none
*/
LUA_API void (ldv_dump_long_string)(const int indent, lua_State* L, const TString* string);
